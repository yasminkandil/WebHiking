...
<body>		<form method="Post">
	...
	<div class="form-control">
			...
			<label for="inp-1">
			<input type="radio" name="Fifth" value="Recommended by Friends"required>Recommended by Friends</input>
			</label>
			<label for="inp-2">
			<input type="radio" name="Fifth" value="Social media"required>Social media</input>
			</label>
			<label for="inp-3">
			<input type="radio" name="Fifth" value="Blog or Publication"required>Blog or Publication</input>
			</label>
			<label for="inp-4">
			<input type="radio" name="Fifth" value="Other"required>Other</input>
			</label>
		</div>
		<div class="form-control" >
			...
			<label for="Once">
				<input type="radio"
					id="Once"
					name="First" value="Once"required>Once</input>
			</label>
			<label for="Twice">
				<input type="radio"
					id="Twice"
					name="First" value="Twice"required>Twice</input>
			</label>
			<label for="More">
				<input type="radio"
					id="More"
					name="First" value="More"required>More</input>
			</label>
		</div>
		<div class="form-control">
		...
		<label for="inp-1">
				<input type="radio"
					name="Second" value="A day hiker"required>A day hiker</input></label>
			<label for="inp-2">
				<input type="radio"
					name="Second" value="An overnight backpacker (maximum 4 nights)"required>An overnight backpacker (maximum 4 nights)</input></label>
			<label for="inp-3">
				<input type="radio"
					name="Second" value="A long distance hiker (5 or more nights)"required>A long distance hiker (5 or more nights)</input></label>
			<label for="inp-4">
				<input type="radio"
					name="Second" value="A through hiker who is doing the entire
                        Appalachian trail this year "required>A through hiker who is doing the entire
		...
		<div class="form-control">
			...
			<label for="inp-1">
				<input type="radio" name="Third" value="Yes"required>Yes</input>
			</label>
			<label for="inp-2">
				<input type="radio" name="Third" value="Mostly, we did our best"required>Mostly, we did our best</input>
			</label>
			<label for="inp-3">
				<input type="radio" name="Third" value="No, we were a couple in a relationship and we are no longer"required>No, we were a couple in a relationship and we are no longer</input>
			</label>
			<label for="inp-4">
				<input type="radio" name="Third" value="Other" required>Other</input>
			</label>
		</div>
     ...
     <div class="form-control">
			...
			<label for="inp-1">
			<input type="radio" name="Fourth" value="Yes" required>Yes</input>
			</label>
			<label for="inp-2">
			<input type="radio" name="Fourth" value="No"required>No</input>
			</label>
		</div>
