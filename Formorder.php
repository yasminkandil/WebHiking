...
$CVV=filter_var($_POST['cvv'],FILTER_SANITIZE_STRING);
      ...
      $sql="INSERT INTO deliverydetails(Address,City,State,Zip,CardName,CridetCardNum,ExpMonth,ExpYear,CVV) VALUES (
      '".$fname."','".$Address."','".$Email."','".$city."','".$State."','".$Zip."','".$Cname."','".$cardnum."','".$Expmonth."','".$Expyear."','".$CVV."')";
